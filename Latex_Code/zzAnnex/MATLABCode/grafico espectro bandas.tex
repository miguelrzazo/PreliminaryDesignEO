...
% Crear el grafico con escala logaritmica
semilogx([1e9, 1e15], [0, 0], 'HandleVisibility', 'off'); % Linea invisible
hold on;

% Dibujar las bandas usando rectangulos 
...
% Configuracion de etiquetas y titulo
