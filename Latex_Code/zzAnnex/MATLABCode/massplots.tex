...
% GenerateMassPlots: Crea graficos de masa para las configuraciones viables.
%
% Descripcion:
% Esta funcion genera dos tipos de graficos para cada configuracion unica
...
fprintf('Generando graficas de masa para las soluciones encontradas...\n');

%% ========================================================================
% 2. GENERACION DE GRAFICOS POR CONFIGURACION
% ========================================================================
unique_configs = unique(results_table(:, {'Num_Satelites', 'Num_Telescopios', 'ID_Detector', 'Tipo_Telescopio'}), 'rows');

% Iterar sobre cada configuracion unica
for i = 1:height(unique_configs)
    ...
    % Filtrar datos para la configuracion actual
    ...
    % --- GRAFICO 1: COMPARATIVA DE MASA SECA ---
    ...
    % Plot de la masa propuesta para la configuracion actual
    ...
    % Si la configuracion actual es de 2 telescopios, anade la linea de 1 telescopio para comparar
    if N_tel >= 2
        % Estimar la masa seca para una configuracion de 1 telescopio dividiendo por 1.5
        % segun la logica de 'calcularMasaSeca.m'.
    ...
    % Configuracion del grafico (titulo, etiquetas, etc.)
    ...
    % --- GRAFICO 2: DESGLOSE DE MASA VS ALTURA ---
    ...
    % Anotacion para la masa total minima
...
fprintf('Graficas de masa guardadas en las carpetas ''%s'' y ''%s''.\n', dry_mass_plot_dir, total_mass_plot_dir);
