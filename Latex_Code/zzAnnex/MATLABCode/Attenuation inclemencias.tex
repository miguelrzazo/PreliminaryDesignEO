...
%% Modelado de Atenuacion por Inclemencias del Tiempo en Banda X
% Este script simula la velocidad de descarga en banda X bajo diferentes
% condiciones meteorologicas durante un ano completo
...
% Configurar interprete LaTeX por defecto
set(groot, 'defaultAxesTickLabelInterpreter', 'latex');
set(groot, 'defaultTextInterpreter', 'latex');
set(groot, 'defaultLegendInterpreter', 'latex');

% Parametros de simulacion
dias_simulacion = 365; % Un ano completo

% Parametros de velocidad (Mbps) - [min, max]
VELOCIDADES = containers.Map(...
    {'Cielo despejado', 'Lluvia moderada', 'Tormenta extrema', 'Nubes densas'}, ...
    {[120, 150], [75, 100], [22, 38], [90, 110]});

% Probabilidades de condiciones meteorologicas por estacion (%)
...
%% Generar datos meteorologicos diarios
...
for dia = 1:dias_simulacion
    ...
    % Generar condicion meteorologica segun probabilidades
    rand_val = rand() * 100;
    ...
    % Generar velocidad segun la condicion
...
%% Calculo de velocidad promedio semanal
...
%% Grafica de velocidad promedio semanal
figure('Position', [100, 100, 1000, 600]);
hold on;

% Usar colores mas visibles y contrastantes
color_principal = [0, 0.4470, 0.7410]; % Azul mas visible
...
% Linea de media anual con color contrastante
...
%% Grafica de velocidad diaria
figure('Position', [150, 150, 1000, 600]);
hold on;

% Definir colores mas visibles y diferenciables
colores_visibles = [
...
% Graficar puntos por condicion con mayor tamano
...
% Linea de media anual en negro para mejor contraste
...
%% Resumen estadistico
fprintf('\nResumen Estadistico:\n');
fprintf('%-20s %-10s %-10s %-12s\n', 'Condicion', 'Media', 'Dias', 'Porcentaje');
