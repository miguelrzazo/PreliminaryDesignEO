...
\usepackage{xurl} %% Para permitir saltos de línea en URL largas
...
\usepackage{threeparttable} % Para notas al pie de tablas sin conflicto con tabularx
...
\usepackage[dvipsnames,table]{xcolor} % Para dar texto de colores al codigo
\usepackage{csquotes} %% Para comillas español
\usepackage{fancyvrb} % Mejor verbatim mas elegante
% minted replaced by listings (minted v3.7 generates 150k+ PDF objects via pygmentize)
\usepackage{listings}
\lstset{
  ...
  columns=flexible,
  extendedchars=true,
  literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1 {ñ}{{\~n}}1 {Á}{{\'A}}1 {É}{{\'E}}1 {Í}{{\'I}}1 {Ó}{{\'O}}1 {Ú}{{\'U}}1 {Ñ}{{\~N}}1 {ü}{{\"u}}1 {Ü}{{\"U}}1 {º}{{\textordmasculine}}1 {°}{{\ensuremath{^\circ}}}1 {¿}{{?`}}1 {¡}{{!`}}1 {µ}{{\textmu}}1 {μ}{{\textmu}}1 {²}{{$^2$}}1 {³}{{$^3$}}1 {≥}{{$\ge$}}1 {≤}{{$\le$}}1 {⁻}{{$^-$}}1 {·}{{\textperiodcentered}}1 {η}{{$\eta$}}1 {γ}{{$\gamma$}}1 {λ}{{$\lambda$}}1 {Δ}{{$\Delta$}}1 {—}{{---}}1,
}
\usepackage{multicol}
...
\usepackage{gensymb}
\usepackage{enumitem}  % custom description list formatting
...
\begin{document}
\pagenumbering{roman}
% Usar un contador interno monotónico para evitar destinos duplicados cuando
% la numeración visible se reinicia en el anexo.
...
\include{1.Introduccion/Introduccion}
\include{2.Misiones_Semejantes/00Misiones_Semejantes}
\include{3.Conceptos_Previos/00Conceptos_Previos}

\include{4.Payload/00Payload}

\include{5.Mission/00AnalisisMision}
\include{6.Lanzadores/00Lanzador}
\include{7.Segmento_Tierra/00Segmento_Tierra}
\include{8.Conclusiones/00Conclusiones}
