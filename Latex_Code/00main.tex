...
\lstset{
  ...
  columns=flexible,
  extendedchars=true,
  literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1 {ñ}{{\~n}}1 {Á}{{\'A}}1 {É}{{\'E}}1 {Í}{{\'I}}1 {Ó}{{\'O}}1 {Ú}{{\'U}}1 {Ñ}{{\~N}}1 {ü}{{\"u}}1 {Ü}{{\"U}}1 {º}{{\textordmasculine}}1 {°}{{\textdegree}}1 {¿}{{?`}}1 {¡}{{!`}}1 {µ}{{\textmu}}1 {μ}{{\textmu}}1 {²}{{$^2$}}1 {³}{{$^3$}}1 {≥}{{$\ge$}}1 {≤}{{$\le$}}1 {⁻}{{$^-$}}1 {·}{{\textperiodcentered}}1 {η}{{$\eta$}}1 {γ}{{$\gamma$}}1 {λ}{{$\lambda$}}1 {Δ}{{$\Delta$}}1 {—}{{---}}1,
}
\usepackage{multicol}
