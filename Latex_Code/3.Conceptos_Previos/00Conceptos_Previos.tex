...
\noindent Estos parámetros no tendrán mucha relevancia en este trabajo como veremos más adelante, ya que por simplicidad escogeremos una órbita circular$(e\approx0)$. El semieje mayor se podrá resumir en la altura orbital,
...
\begin{itemize}
    ...
    \item \( R_T \approx 6378.1 \ \text{km} \) es el radio ecuatorial de la Tierra,
...
donde $n_k(a)=\sqrt{\mu/a^3}$ es el movimiento medio kepleriano,
$\omega_{\oplus}$ es la velocidad angular de rotación terrestre y
$\dot{\Omega}$, $\dot{\omega}$ y $\dot{M}_1$ son las tasas seculares
asociadas a $J_2$. Las expresiones generales de estas tasas son:
...
circular empleado en este diseño, $e=0$ y $p=a$; por tanto, el período
nodal se obtiene como:
...
Una órbita \textit{frozen} mantiene constantes la excentricidad y el argumento
del perigeo anulando sus derivadas seculares. La condición se obtiene del
acoplamiento entre $J_2$ y $J_3$:

\begin{equation}
e_{\textit{frozen}} \approx -\frac{J_3}{2J_2}\,\frac{R_T}{a}\,\sin i,
\qquad \omega = 90^\circ\ \text{o}\ 270^\circ
\label{eq:frozen_cond}
\end{equation}

donde $J_3 \approx -2.53 \times 10^{-6}$ es el armónico zonal impar que
rompe la simetría norte-sur del campo gravitatorio.

El interés de esta condición para una misión de observación de la Tierra
reside en que, al mantener $e$ y $\omega$ constantes frente a las
perturbaciones de $J_2$ y $J_3$, el perfil de altura sobre cada latitud se
repite de forma prácticamente idéntica en cada órbita. Esto asegura un GSD
y una iluminación uniformes a lo largo de toda la vida útil de la misión,
además de una geometría de observación repetible, tal como emplean
misiones de referencia como Landsat o Sentinel-2.
