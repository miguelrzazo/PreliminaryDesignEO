...
donde \( F\# = \frac{f}{D} \) es la relación focal del sistema, con \( f \) la distancia focal y \( D \) el diámetro de la apertura.\footnote{Para los sistemas con obstrucción central se utilizará la relación focal equivalente $T\#$, definida más adelante en la ecuación \ref{relfoc}}.
...
Siendo $R_{obs}$ la misma relación de obstrucción en la ecuación \ref{mtfrobs}.
...
\hline
\textbf{Tipo} & \textbf{Obstrucción($R_{obs}$)} & \textbf{$FoV_{lim}$} & \textbf{MTF\textsubscript{Alineamiento}} & \textbf{Transmisión óptica $(\tau)$} \\
\hline
