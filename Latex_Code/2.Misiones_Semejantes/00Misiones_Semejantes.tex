...
La constelación GHGSat representa un enfoque comercial a la monitorización de gases de efecto invernadero. Esta constelación se dedica a la detección de emisiones de metano y CO$_\textsubscript{2}$ a nivel de instalaciones individuales, ofreciendo una resolución espacial excepcionalmente alta para aplicaciones específicas de monitorización de fuentes puntuales.
