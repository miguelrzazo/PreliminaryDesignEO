...
Se muestra, en primer lugar, un resumen de los parámetros más relevantes escogidos como solución al problema propuesto, para facilidad del lector:
\hfill \break
