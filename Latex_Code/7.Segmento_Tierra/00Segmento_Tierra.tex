...
\noindent\footnotesize $^*$ Incluye días despejados y con precipitación sólida (nieve/aguanieve). En banda X (8,1\,GHz), la nieve seca introduce $<$0,05\,dB de atenuación, despreciable frente al margen de enlace de 22,8\,dB. Lluvia moderada: $R < 10$\,mm/h; lluvia intensa: $R \geq 10$\,mm/h (clasificación OMM).
...
Se aprecia una velocidad media anual de \textbf{131 Mbps}, lo cual supone una pérdida del 12,7\% respecto al máximo teórico, debida principalmente a los episodios de lluvia en verano.
...
$$
\text{Velocidad real} = 131\ \text{Mbps} \times 0{,}875 \times 0{,}75 = \boxed{86\ \text{Mbps}}
$$
...
\begin{equation}
t_{\text{descarga}} = \frac{8{,}843\ \text{GB}}{86\ \text{Mbps} \times \frac{1}{8}\ \text{MB/s}} = \frac{8843}{10{,}75} = \boxed{823\ \text{segundos}}
\end{equation}
