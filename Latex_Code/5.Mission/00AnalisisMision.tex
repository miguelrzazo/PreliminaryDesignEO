...
\subsection*{Modo detumbling}

Tras la separación del desplegador, el satélite presentará una velocidad angular residual que debe ser eliminada antes de iniciar el apuntamiento nadir. El controlador \textbf{B-dot} gestiona esta fase: genera pares magnéticos proporcionales a $\dot{\mathbf{B}}$, disipando la energía de rotación. La estabilización completa se logra típicamente en 1--3 órbitas, tras lo cual el sistema transita al modo nominal de seguimiento nadir.
...
Para el enlace de descarga se ha seleccionado el \textbf{transceptor X-Band IQ Spacecom XLink-X}, un radio definido por software (SDR) de alta tasa. Opera entre 8,025 y 8,400\,GHz con una tasa de transmisión de hasta 200\,Mbps, potencia de salida de 1\,W y consumo en transmisión de 16\,W. Su masa es de 200\,g \cite{iqspacecom_xlinkx_2024}.
