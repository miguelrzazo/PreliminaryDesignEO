...
% CoverageRevisitCalc: Calcula el tiempo de revisita para una configuración de satélite.
%
% Esta función evalúa el tiempo de revisita para un rango de alturas orbitales y
% anchos de barrido (swaths), generando un mapa de calor con los resultados.
% Considera las limitaciones físicas del sistema, como el campo de visión (FOV)
% del telescopio y la configuración máxima del detector.

% --- Constantes y Parámetros Orbitales ---
R_E = 6378.137e3; % Radio ecuatorial de la Tierra [m]
mu_E = 3.986004418e14; % Constante gravitacional terrestre [m3/s2]
J2 = 1.082629989052e-3; % Armónico zonal J2
